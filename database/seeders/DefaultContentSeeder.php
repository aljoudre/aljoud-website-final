        ...
        if (Project::count() === 0) {
            $projects = [
                [
                    ...
                    'subtitle' => [
                        'ar' => 'مشروع سكني متكامل',
                        'en' => 'Integrated Residential Project',
                    ],
                    'location' => [
                        'ar' => 'الرياض، حي النرجس',
                        'en' => 'Riyadh, Al-Nargis District',
                    ],
                    'type' => [
                        'ar' => 'سكني',
                        'en' => 'Residential',
                ...
                [
                    ...
                    'subtitle' => [
                        'ar' => 'مجمع تجاري وسكني',
                        'en' => 'Commercial and Residential Complex',
                    ],
                    'location' => [
                ...
                [
                    ...
                    'location' => [
                        'ar' => 'الدمام، الواجهة البحرية',
                        'en' => 'Dammam, Waterfront',
                    ],
                    'type' => [
                        'ar' => 'سكني',
                        'en' => 'Residential',
                ...
                [
                    ...
                    'subtitle' => [
                        'ar' => 'مشروع استدامة بيئية',
                        'en' => 'Environmental Sustainability Project',
                    ],
                    'location' => [
                        'ar' => 'الرياض، شمال المدينة',
                        'en' => 'Riyadh, North of City',
                    ],
                    'type' => [
                        'ar' => 'سكني',
                        'en' => 'Residential',
                ...
                [
                    ...
                    'subtitle' => [
                        'ar' => 'مركز تسوق وتجاري',
                        'en' => 'Shopping and Commercial Center',
                    ],
                    'location' => [
